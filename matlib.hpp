...
inline mat4 perspectiveProj(float ang = 90 * M_PI / 180, float n = 1, float f = 100, float a = 16/9) {
...
inline mat4 GLperspectiveProj(float ang = 90, float n = 1, float f = 100, float a = 16 / 9)
{
    const float t = 1 / tan(ang * M_PI / 360.0f); // the scaling factor for x and y
    return mat4(
        t / a, 0, 0, 0,
        0, t, 0, 0,
